...
exports.requestAccountVerificationUseCase =
  exports.generateAndSendUserAccountVerificationEmail =
  exports.requestAccountVerificationUseCaseBase =
    void 0;
...
const requestAccountVerificationUseCaseBase =
  (dependencies) => async (user) => {
...
async function generateAndSendUserAccountVerificationEmail(user, usersRepo) {
  ...
  generateAccountVerificationToken_util_1.generateAccountVerificationTokenForUser)(
    user
  );
  ...
  await (0, sendVerificationMail_usecase_1.sendUserVerificationMailUseCase)(
    user,
    {
      link: link,
    }
...
exports.requestAccountVerificationUseCase = (0,
exports.requestAccountVerificationUseCaseBase)({
