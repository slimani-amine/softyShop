...
const updateProfileSchema = zod_1.z
  .object({
    ...
    location: zod_1.z
      ...
      .refine((data) => data.length === 2, {
        message:
          "La location du boutique string et doit contenir exactement deux nombres",
      }),
    ...
    socialMediaLinks: zod_1.z.union([
  ...
  .strict(
    `${errors_common_1.ZodValidationMessageCommon.FIELDS_UNEXPECTED_MESSAGE}`
  )
  .refine(
    (data) =>
