...
exports.createStoreUseCase =
  exports.validatecreateStorePayload =
  exports.createStoreUseCaseBase =
    void 0;
...
function validatecreateStorePayload(payload) {
  (0, validate_schema_1.trimAndValidateSchemaPayload)(
    createStore_schema_1.default,
    payload
  );
  return payload;
}
