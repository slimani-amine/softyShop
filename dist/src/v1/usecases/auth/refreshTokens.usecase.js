...
exports.refreshUserTokensUseCase = exports.refreshUserTokensUseCaseBase =
  void 0;
...
const refreshUserTokensUseCaseBase =
  (dependencies = { usersRepo: users_repository_1.usersRepo }) =>
  async (user) => {
    ...
    const accessToken = (0, createUserTokens_usecase_1.createUserAccessToken)(
      userFound
    );
    const refreshToken = (0, createUserTokens_usecase_1.createUserRefreshToken)(
      userFound
    );
    return {
      user: userFound,
