...
export type FindOptionsWherePropertyNoObject<PropertyToBeNarrowed> = PropertyToBeNarrowed extends Promise<infer I> ? FindOptionsWhereProperty<NonNullable<I>> : PropertyToBeNarrowed extends Array<infer I> ? FindOptionsWhereProperty<NonNullable<I>> : PropertyToBeNarrowed extends infer I ? I : never;
...
export type PartialEntityUpdate<T> = {
    [P in keyof T]?: T[P] extends (...any: any[]) => any ? never : T[P] extends object ? never : T[P];
};
export declare class FindOperator<T> extends FindOperatorOrm<T> {
}
